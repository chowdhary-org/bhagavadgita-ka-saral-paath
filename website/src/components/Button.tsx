...
const variantStyles = {
  solid: {
    ...
    blue: 'bg-amber-600 text-white hover:bg-amber-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600 active:bg-amber-700 active:text-white/80 disabled:opacity-30 disabled:hover:bg-amber-600',
    white:
  ...
  outline: {
    ...
    blue: 'border-amber-300 text-amber-600 hover:border-amber-400 hover:bg-amber-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600 active:text-amber-600/70 disabled:opacity-40 disabled:hover:border-amber-300 disabled:hover:bg-transparent',
  },
}
