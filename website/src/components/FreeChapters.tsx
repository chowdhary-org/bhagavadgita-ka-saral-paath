...
export function FreeChapters() {
  return (
    <section
      ...
      className="scroll-mt-14 bg-amber-600 sm:scroll-mt-32"
    >
      <div className="overflow-hidden lg:relative">
        ...
        >
          ...
          <div>
            ...
            <p className="mt-4 text-lg tracking-tight text-amber-200">
          ...
          <form className="lg:pl-16">
            ...
            <div className="mt-4 sm:relative sm:flex sm:items-center sm:py-0.5 sm:pr-2.5">
              <div className="relative sm:static sm:flex-auto">
                ...
                />
                <div className="absolute inset-0 rounded-md border border-white/20 peer-focus:border-amber-300 peer-focus:bg-amber-500 peer-focus:ring-1 peer-focus:ring-amber-300 sm:rounded-xl" />
              </div>
              <Button
                type="submit"
                color="white"
