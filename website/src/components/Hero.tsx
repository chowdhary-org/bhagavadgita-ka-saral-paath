  ...
  return (
    <figure className="relative mx-auto max-w-md text-center lg:mx-0 lg:text-left">
      ...
      <figcaption className="mt-2 text-sm text-slate-500">
        <strong className="font-semibold text-amber-600">हरजोत कौर</strong>,
        अध्यक्ष, राजस्व बोर्ड, बिहार सरकार
      </figcaption>
    </figure>
  )
}
    ...
    <header className="overflow-hidden bg-slate-100 lg:bg-transparent lg:px-5">
      <div className="mx-auto grid max-w-6xl grid-cols-1 grid-rows-[auto_1fr] gap-y-16 pt-16 md:pt-20 lg:grid-cols-12 lg:gap-y-20 lg:px-3 lg:pt-20 lg:pb-36 xl:py-32">
        <div className="relative flex items-end lg:col-span-5 lg:row-span-2">
          <div className="absolute -top-20 right-1/2 -bottom-12 left-0 z-10 rounded-br-6xl bg-amber-600 text-white/10 md:bottom-8 lg:-inset-y-32 lg:right-full lg:left-[-100vw] lg:-mr-40">
            <GridPattern
              x="100%"
              y="100%"
