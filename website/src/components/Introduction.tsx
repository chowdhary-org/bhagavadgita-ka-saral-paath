    ...
    >
      <Container className="text-lg tracking-tight text-slate-700">
        <p className="font-display text-4xl font-bold tracking-tight text-slate-900">
          ...
          गूढ़ रहस्यों को समझने में मदद करता है।
        </p>
        <p className="mt-4">
          भगवद्गीता आध्यात्मिक ज्ञान का अमूल्य खजाना है। यह पुस्तक भगवद्गीता के
          श्लोकों को सरल हिंदी में प्रस्तुत करती है, जिससे हर कोई इसके गहन
          अर्थों को समझ सके।
        </p>
        <p className="mt-4">
        ...
        <p className="mt-4">
          ...
          जीवन के महत्वपूर्ण सवालों के जवाब दिए।
        </p>
